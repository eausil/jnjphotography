							...
							<div class="col-lg-7 col-md-9 col-12">
								...
								<div class="main-menu">
									<nav class="navigation">
										<ul class="nav menu">
											<li><a href="<?php echo e(route('preview')); ?>">Preview</a></li>  
                                            <li class="active"><a href="<?php echo e(route('preview')); ?>">Register</a></li>
                                            <?php if(!Auth::check()): ?>
...
<body>
    <div class="center">
        ...
        <form action="#" method="post">
            ...
            <p>Don't have an account? <a href="<?php echo e(route('register')); ?>">Register</a></p><br><br>
        </form>
    </div>
</body>
...
<?php /**PATH C:\Users\audre\OneDrive\Desktop\J'sMemorableEvents\JsMemorableEvents\resources\views\signin.blade.php ENDPATH**/ ?>